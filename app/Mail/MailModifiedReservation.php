...
class MailModifiedReservation extends Mailable
{
     ...
     * @return void
     */
    public function __construct($email, Reservation $reservation, $user, $business_name)
    {
    ...
    {
        return $this->subject("Trapezaki Modified Reservation")->view('emails.modified');
    }
}
