...
Route::domain('www.' . env('APP_URL'))->group(function () {
    ...
    //TODO: na mpei sto search or book
    ...
    Route::post('/api/change-city',[SessionsU3Controller::class,'changeCity']);
    ...
    Route::middleware(['guest:user3'])->group(function () {
        ...
        Route::get('/signup', [RegisterU3Controller::class, 'view']);
        ...
        //Route::post('/selected-profile', [RegisterU3Controller::class, 'createGuest']);
    ...
    Route::middleware(['auth:user3'])->group(function () {
        ...
        Route::get('/logout', [SessionsU3Controller::class, 'destroy']);
...
Route::domain('business.' . env('APP_URL'))->group(function () {
    ...
    Route::middleware(['guest:user2'])->group(function () {
        ...
        Route::get('/signup', [RegisterU2Controller::class, 'view']);
    ...
    Route::middleware(['auth:user2'])->group(function () {
        ...
        Route::get('/logout', [SessionsU2Controller::class, 'destroy']);
        ...
        Route::get('/profile/menu', [MenuController::class, 'show']);
...
Route::domain('admin.' . env('APP_URL'))->group(function () {
    ...
    Route::middleware(['guest:user1'])->group(function () {
        Route::get('/login', [SessionsU1Controller::class, 'create']);
        Route::get('/', [SessionsU1Controller::class, 'create']);
