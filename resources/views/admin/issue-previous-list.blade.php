                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm checkbox">
                                    ...
                                    <label for="checkActive">Solve</label>
                                </div>
                                <div class="col-sm checkbox">
                                    <input type="checkbox" id="checkDisabled" class='form-check-input' unchecked>
                                    <label for="checkDisabled">I can't Solve</label>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <td class="col-8">
                                                    <a href="/seven-seas">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <p class="font-bold ms-3 mb-0 text-nowrap">
