...
<head>
    ...
    <title>Trapezaki - Add Reservation</title>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-select" id="inputGroupSelect01">
                                                ...
                                                <option value="1">30/11/21</option>
                                    ...
                                    <div class="card">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1"
                                                    rows="3" placeholder="Details"></textarea>
                                    </div>
                                    <div class="card"></div>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Login - Let's go out</title>
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@300;400;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="/assets/css/bootstrap.css">
    <link rel="stylesheet" href="/assets/vendors/bootstrap-icons/bootstrap-icons.css">
    <link rel="stylesheet" href="/assets/css/app.css">
...
addDefaultObjects()
                            ...
                            <div class="popup">
                              <div class="popup" onclick="myFunction()">
                                ...
                                <span class="popuptext" id="myPopup">Succesfully added! Resv ID = #818181</span>
                              </div>
