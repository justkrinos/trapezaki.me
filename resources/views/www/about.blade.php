                        ...
                        <div class="card-body">
                            <div class="row">
                                                        ...
                                                        <div class="col-xl-2 col-md-4 col-md-5">
                                                            <div class="card">
                                                                <div class="card-content">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <h5 class="card-title-center">Krinos Vasileiou
                                                                        </h5>
                                                                    </div>
                                                                </div>
                                                                <ul class="list-group list-group-flush">
                                                                    <li class="list-group-item">The Project Manager.
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-content">
                                                                    <img src="/assets/images/andreas.jpg"
                                                                        class="card-img-top img-fluid">
                                                                    <div class="card-body">
                                                                        <h5 class="card-title">Andreas Efstathiou
                                                                        </h5>
                                                                    </div>
                                                                </div>
                                                                <ul class="list-group list-group-flush">
                                                                    <li class="list-group-item"> The King of the
                                                                        backend.
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-content">
                                                                    <img src="/assets/images/stefanos.jpg"
                                                                        class="card-img-top img-fluid">
                                                                    <div class="card-body">
                                                                        <h5 class="card-title">Stefanos Hannadjias
                                                                        </h5>
                                                                    </div>
                                                                </div>
                                                                <ul class="list-group list-group-flush">
                                                                    <li class="list-group-item">The Marketing Director.
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                ...
                                <h5 class="text-center">
                                    This project is developed by a group of third year students of Computer Engineering
                                    and
                                    Informatics
