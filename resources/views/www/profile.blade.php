                                    ...
                                    <div class="col-md-6">
                                        <form method="POST" action="/profile" class="col-md-12">
                                            ...
                                            <div class="col-sm-12 d-flex justify-content-end">
                                                <button type="submit" name="form1" class="btn btn-primary me-1 mb-1">Save Changes</button>
                                    ...
                                    <div class="col-md-6">
                                        <form method="POST" action="/profile" class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control form-control-l"
                                                    id="new-password_confirmation" name="new-password_confirmation" placeholder="Password" required>
                                            ...
                                            <div class="form-group">
                                                <input type="hidden" class="form-control" id="username" name="username" value="{{Auth::guard('user3')->user()->username}}">
                                            </div>

                                            <div class="col-sm-12 d-flex justify-content-end">
                                                <button type="submit" name="form2" class="btn btn-primary me-1 mb-1">Change</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
